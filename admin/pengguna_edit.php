...
if (isset($_POST['btn-simpan'])) {
    ...
    if ($_FILES['gambar']['error'] == UPLOAD_ERR_OK) {
        ...
        $gambar = $edit['gambar']; // Jika tidak ada gambar baru diunggah, gunakan gambar yang sudah ada
    }

    // Periksa apakah password diisi
    if ($_POST['password'] != null || $_POST['password'] == '') {
        $pass     = md5($_POST['password']);
        $query = "UPDATE user SET nama_user = '$nama', username = '$username', gambar = '$gambar', role = '$role', password ='$pass' WHERE id_user = '$id_user'";
    } else {
        $query = "UPDATE user SET nama_user = '$nama', username = '$username', gambar = '$gambar', role = '$role' WHERE id_user = '$id_user'";
    }
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="gambar" class="form-control" value="<?= $edit['gambar'] ?>">
                            </div>
                            <div class="form-group">
                                <label>Role</label>
