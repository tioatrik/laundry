...
// $query = "SELECT transaksi.*, member.nama_member, detail_transaksi.total_harga, detail_transaksi.total_pajak
//           FROM transaksi 
...
// $query = "SELECT transaksi.*, member.nama_member, detail_transaksi.total_harga, detail_transaksi.total_pajak, detail_transaksi.total_diskon
//           FROM transaksi 
//           INNER JOIN member ON member.id_member = transaksi.member_id 
//           INNER JOIN detail_transaksi ON detail_transaksi.transaksi_id = transaksi.id_transaksi 
//           WHERE transaksi.id_transaksi = " . $_GET['id'];

$query = "SELECT transaksi.*, member.nama_member, detail_transaksi.total_harga, detail_transaksi.total_pajak, detail_transaksi.total_diskon, detail_transaksi.total_asli
          FROM transaksi 
          INNER JOIN member ON member.id_member = transaksi.member_id 
          INNER JOIN detail_transaksi ON detail_transaksi.transaksi_id = transaksi.id_transaksi 
          WHERE transaksi.id_transaksi = " . $_GET['id'];
            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <strong>Total Rp <?= $data['total_asli'];  ?></strong><br>
                        <strong>Pajak anda Rp. <?= $data['total_pajak'];  ?></strong><br>
                        <strong>Biaya tambahan Rp. <?= $data['biaya_tambahan'];  ?></strong> <br>
                        <strong>Anda mendapatkan diskon sebesar Rp. <?= $data['total_diskon'];  ?> </strong><br>
